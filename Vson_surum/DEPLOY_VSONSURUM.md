# NİYET VSONSURUM — GitHub / Render Dağıtımı

## GitHub güncellemesi
1. `VSONSURUM_GITHUB_GUNCELLEME.zip` dosyasını açın.
...
5. Önerilen commit mesajı: `VSONSURUM final feature and UX calibration`
