...
@app.get('/healthz')
def healthz():
    return j({'ok':True,'version':'VFINAL3','ai_configured':bool(core.API_KEY)})
...
def analyze_fast_route():
    ...
    try:
        ...
        return j({'analysis':a,'model':core.MODEL,'version':'VFINAL3','stage':'primary'})
...
def analyze_enrich_route():
    ...
    try:
        ...
        return j({'analysis':a,'model':core.MODEL,'version':'VFINAL3','stage':'enrichment'})
    except Exception:
...
def context_shadow_route():
    ...
    try:
        ...
        return j({'shadow':out,'model':core.MODEL,'version':'VFINAL3'})
    except Exception:
...
def analyze_route():
    ...
    try:
        ...
        return j({'analysis':a,'model':core.MODEL,'version':'VFINAL3'})
    except Exception:
