...
V13'te anket sonuçları yalnızca arayüzde istatistik olarak gösterilmez. `calibration_profile.json` içindeki intercept ve 7×15 katsayı matrisi `run_v13.py` tarafından her gerçek Luna analizinde uygulanır.
