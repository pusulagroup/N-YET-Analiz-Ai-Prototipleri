...
V12.3'de anket sonuçları yalnızca arayüzde istatistik olarak gösterilmez. `calibration_profile.json` içindeki intercept ve 7×15 katsayı matrisi `run_v11.py` tarafından her gerçek Luna analizinde uygulanır.
